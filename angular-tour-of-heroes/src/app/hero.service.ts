...
import {MessageService} from './message.service'; // HttpClient클래스가 제공하는 메소드 : 모두 RxJS가 제공하는 Observable타입 반환함
...
export class HeroService {
  ...
  getHeroes(): Observable<Hero[]> {
    ...
    this.messageService.add('HeroService : fetched heroes'); // 메세지 보내기
